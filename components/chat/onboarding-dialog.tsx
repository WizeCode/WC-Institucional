    ...
    const steps = [
        {
            ...
            description:
                "O assistente da WizeCode que transforma sua ideia em uma proposta personalizada.",
        },
        {
            media: (
                <div className="flex h-52 flex-col items-center justify-center gap-1 rounded-xl bg-linear-to-br from-amber-500 to-orange-600">
                    <span className="text-[80px] leading-none font-bold text-white/90">
                        20
                    </span>
            ...
            description:
                "Sem formulários chatos. O Wizard conduz a conversa e coleta o que nossa equipe precisa.",
        },
        {
        ...
        },
        {
            media: (
                <div className="flex h-52 items-center justify-center rounded-xl bg-linear-to-br from-emerald-500 to-teal-600">
                    <ShieldCheck
                        className="size-20 text-white/90"
                        strokeWidth={1.5}
                    />
                </div>
            ),
            ...
            description:
                "Só enviamos suas informações com sua confirmação. Nada é coletado sem você saber.",
        },
    ]
