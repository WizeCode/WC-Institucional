...
import { Globe, Menu, LayoutTemplate, Monitor, Zap } from "lucide-react"
...
const Navbar = ({
            ...
            items: [
                {
                    ...
                    description:
                        "Sites institucionais modernos e profissionais",
                    icon: <Globe className="size-5 shrink-0" />,
                    url: "/servicos/website-institucional",
                },
                {
                    title: "Landing Page",
                    description: "Páginas de alta conversão para o seu negócio",
                    icon: <LayoutTemplate className="size-5 shrink-0" />,
                    url: "/servicos/landing-page",
                },
                {
                    title: "Sistema",
                    description: "Sistemas web personalizados para sua empresa",
    ...
    return (
        <section
            className={cn(
                "flex w-full justify-center p-4 shadow-md",
                className
            )}
        >
