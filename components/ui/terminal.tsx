...
export const Terminal = ({
    ...
    const content = (
        ...
        >
            <div className="flex flex-col gap-y-2 rounded-t-xl border-b border-muted bg-muted p-4">
            ...
            <pre className="p-4 wrap-break-word whitespace-pre-wrap">
                <code className="grid gap-y-1 overflow-hidden">
                    {wrappedChildren}
                </code>
            </pre>
        </div>
